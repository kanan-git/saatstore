...
urlpatterns = [
    ...
    path('about/', products_view.about, name='about'),
    path('contactus/', products_view.contact, name='contact'),
    path('login1/', products_view.login1, name='login1'),
    path('register1/', products_view.register1, name='register1')
]
